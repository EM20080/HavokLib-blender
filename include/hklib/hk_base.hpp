...
MAKE_ENUM(ENUMSCOPE(hkToolset : uint8, hkToolset), EMEMBER(HKUNKVER),
          EMEMBER(HK330B2), EMEMBER(HK500), EMEMBER(HK510), EMEMBER(HK550),
          EMEMBER(HK600),
          ...
          EMEMBER(HK2013_2), EMEMBER(HK2014), EMEMBER(HK2014_2),
          EMEMBER(HK2015_1),
          EMEMBER(HK2015_2), EMEMBER(HK2016_1), EMEMBER(HK2016_2),
          EMEMBER(HK2017), EMEMBER(HK2018),
          EMEMBER(HK2019));
...
struct IhkVirtualClass {
  ...
  virtual operator hkpSimpleMeshShape const *() const { return nullptr; }
