...
static const std::map<JenHash, IhkVirtualClass *(*)(CRule)> hkConstrRegistry{
    ...
    hkCreatorAlias(hkpStorageExtendedMeshShapeShapeSubpartStorage,
    ...
    StaticFor(hkRegisterCreator, hkRootLevelContainer, hkxEnvironment,
              ...
              hkpSampledHeightFieldShape, hkpStorageSampledHeightFieldShape,
              hkpCompressedSampledHeightFieldShape,
              hkpTriSampledHeightFieldCollection,
              hkpTriSampledHeightFieldBvTreeShape,
              hkpMoppCode, hkpMoppBvTreeShape, hkpSimpleMeshShape,
